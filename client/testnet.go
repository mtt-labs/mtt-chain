...
import (
	...
	"github.com/mtt-labs/mtt-chain/server/config"
	...
	"github.com/mtt-labs/mtt-chain/testutil/network"
)
...
func initTestnetFiles(
	...
	for i := 0; i < args.numValidators; i++ {
		...
		coins := sdk.Coins{
			sdk.NewCoin(ethermint.AttoMtt, accStakingTokens),
		}
		...
		createValMsg, err := stakingtypes.NewMsgCreateValidator(
			sdk.ValAddress(addr),
			valPubKeys[i],
			sdk.NewCoin(ethermint.AttoMtt, valTokens),
		...
		customAppTemplate, customAppConfig := config.AppConfig(ethermint.AttoMtt)
	...
	if err := initGenFiles(clientCtx, mbm, args.chainID, ethermint.AttoMtt, genAccounts, genBalances, genFiles, args.numValidators); err != nil {
		return err
	}
...
func initGenFiles(
	...
	mintGenState.Params.Coin.Denom = coinDenom
