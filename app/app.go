...
import (
	...
	"github.com/mtt-labs/mtt-chain/app/ante"
	"github.com/mtt-labs/mtt-chain/x/erc20"
	erc20client "github.com/mtt-labs/mtt-chain/x/erc20/client"
	erc20types "github.com/mtt-labs/mtt-chain/x/erc20/types"

	srvflags "github.com/mtt-labs/mtt-chain/server/flags"
	mtttypes "github.com/mtt-labs/mtt-chain/types"
	"github.com/mtt-labs/mtt-chain/x/evm"
	"github.com/mtt-labs/mtt-chain/x/feemarket"

	erc20keeper "github.com/mtt-labs/mtt-chain/x/erc20/keeper"
	//evm
	evmkeeper "github.com/mtt-labs/mtt-chain/x/evm/keeper"
	evmtypes "github.com/mtt-labs/mtt-chain/x/evm/types"
	"github.com/mtt-labs/mtt-chain/x/evm/vm/geth"
	...
	"github.com/mtt-labs/mtt-chain/docs"
...
func New(
	...
	app.Erc20Keeper = erc20keeper.NewKeeper(
		...
		app.AccountKeeper, app.BankKeeper, app.EvmKeeper, app.MintKeeper,
	)
	...
	*/
	...
	app.EvmKeeper.SetHooks(app.Erc20Keeper.Hooks())
...
func (app *App) AppCdc() *codec.LegacyAmino {
	return app.cdc
}
