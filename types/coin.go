...
const (
	// AttoMtt defines the default coin denomination used in Ethermint in:
	//
...
func NewPhotonCoin(amount sdkmath.Int) sdk.Coin {
	return sdk.NewCoin(AttoMtt, amount)
}
...
func NewPhotonDecCoin(amount sdkmath.Int) sdk.DecCoin {
	return sdk.NewDecCoin(AttoMtt, amount)
}
...
func NewPhotonCoinInt64(amount int64) sdk.Coin {
	return sdk.NewInt64Coin(AttoMtt, amount)
}
