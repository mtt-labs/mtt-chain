...
import (
	...
	types2 "github.com/mtt-labs/mtt-chain/types"
...
func (k Keeper) ConvertCoin(
	...
	// Remove token pair if contracts is suicided
...
func (k Keeper) SetBridge(
	goCtx context.Context,
	msg *types.MsgSetBridge,
) (*types.MsgSetBridgeResponse, error) {
	//msg.FromAddress
	ctx := sdk.UnwrapSDKContext(goCtx)
	...
	return &types.MsgSetBridgeResponse{}, nil
}

func (k Keeper) SetBeginBlock(
	goCtx context.Context,
	msg *types.MsgSetBeginBlock,
) (*types.MsgSetBeginBlockResponse, error) {
	ctx := sdk.UnwrapSDKContext(goCtx)
	params := k.GetParams(ctx)
	adminBech32, err := sdk.AccAddressFromBech32(params.Admin)
	if err != nil {
	...
	err = k.mintKeeper.SetBeginBlock(ctx, msg.Height)
	if err != nil {
		return nil, err
	}
	return &types.MsgSetBeginBlockResponse{}, nil
}

func (k Keeper) FundMint(
	goCtx context.Context,
	msg *types.MsgFundMint,
) (*types.MsgFundMintResponse, error) {
	ctx := sdk.UnwrapSDKContext(goCtx)
	senderBech32, err := sdk.AccAddressFromBech32(msg.FromAddress)
	if err != nil {
		return nil, err
	...
	coin := sdk.NewCoin(denom, sdk.NewInt(int64(msg.Amount)).Mul(sdk.NewInt(int64(math.Pow10(types2.BaseDenomUnit)))))
	err = k.bankKeeper.SendCoinsFromAccountToModule(ctx, senderBech32, minttypes.ModuleName, sdk.NewCoins(coin))
	if err != nil {
		return nil, err
	}
