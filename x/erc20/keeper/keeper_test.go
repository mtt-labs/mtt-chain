...
import (
	...
	"github.com/mtt-labs/mtt-chain/tests"
...
func (suite *KeeperTestSuite) DoSetupTest(t require.TestingT) {
	...
	if suite.mintFeeCollector {
		...
		// update total supply
		bankGenesis := banktypes.NewGenesisState(banktypes.DefaultGenesisState().Params, balances, sdk.NewCoins(sdk.NewCoin(evm.DefaultEVMDenom, sdk.NewInt((int64(params.TxGas)-1)))), []banktypes.Metadata{}, []banktypes.SendEnabled{})
