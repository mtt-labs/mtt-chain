...
// DeployERC20Contract creates and deploys an ERC20 contracts on the EVM with the
...
func (k Keeper) DeployERC20Contract(
	...
	if err != nil {
		return common.Address{}, sdkerrors.Wrapf(err, "failed to deploy contracts for %s", coinMetadata.Name)
	}

	return contractAddr, nil
}

// QueryERC20 returns the data of a deployed ERC20 contracts
...
// BalanceOf queries an account's balance for a given ERC20 contracts
